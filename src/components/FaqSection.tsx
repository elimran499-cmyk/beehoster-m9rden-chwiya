      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${
                filterCategory === cat
                  ? 'bg-[#FF5C3A] text-black shadow-md'
            ...
            return (
              <div
                ...
                className={`rounded-2xl transition-all border ${
                  isOpen
                    ? 'glass-panel-accent border-[#FF9A2E]/60'
              ...
              >
                ...
                >
                  ...
                  <div className={`p-1.5 rounded-full transition-transform duration-300 ${isOpen ? 'rotate-180 bg-[#FF5C3A] text-black' : 'bg-zinc-800 text-zinc-400'}`}>
        ...
        <div className="relative mt-12 p-6 rounded-3xl glass-card glass-edge specular overflow-hidden flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-base font-bold text-white">Staat jouw vraag er niet tussen?</h4>
