...
export const BeehosterLogo: React.FC<React.SVGProps<SVGSVGElement>> = ({
  ...
  <svg viewBox="0 0 64 64" className={className} aria-hidden="true" focusable="false" {...props}>
    <defs>
      <linearGradient id="bh-badge" x1="0" y1="0" x2="0" y2="1">
    ...
    {/* Badge */}
    <rect x="3" y="3" width="58" height="58" rx="20" fill="url(#bh-badge)" stroke="#FF5C3A" strokeWidth="2.5" />
    ...
    {/* Wings */}
    <g fill="url(#bh-gold)" stroke="#FFEBD1" strokeWidth="1.4">
    ...
    {/* Head */}
    <circle cx="32" cy="17.5" r="6" fill="url(#bh-gold)" stroke="#FFEBD1" strokeWidth="1.6" />

    {/* Body carrying the power symbol */}
    <circle cx="32" cy="37" r="12.5" fill="url(#bh-gold)" stroke="#FFEBD1" strokeWidth="1.8" />
