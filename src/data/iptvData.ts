...
export const PACKAGE_TIERS: PackageTier[] = [
  {
    id: 'basic',
    name: 'Basic',
    headline: "Wat zit er in het Basic-pakket?",
    features: [
      'SD / HD / Full HD-kwaliteit',
      '25.000+ zenders + Netflix',
...
export const DURATION_PACKS: DurationPack[] = [
  {
    ...
    savePercent: 30,
    prices: {
      basic: [24.99, 39.99, 49.99, 59.99],
      vip: [34.99, 54.99, 69.99, 84.99],
    },
  },
  {
    id: 'pack-6m',
    ...
    savePercent: 40,
    prices: {
      basic: [34.99, 54.99, 69.99, 84.99],
      vip: [44.99, 69.99, 89.99, 109.99],
    },
  },
  {
    id: 'pack-15m',
    ...
    savePercent: 50,
    prices: {
      basic: [49.0, 79.0, 99.0, 119.0],
      vip: [78.0, 124.0, 156.0, 187.0],
    },
  },
];
